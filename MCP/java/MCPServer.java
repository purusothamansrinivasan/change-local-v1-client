...
// Import Get_Api_V1_Donations_Carbon_StatsMCPTool - included in same package
// Import Post_Api_V1_Donations_CreateMCPTool - included in same package
// Import Get_Api_V1_Donations_ShowMCPTool - included in same package
// Import Get_Api_V1_Nonprofits_ListMCPTool - included in same package
// Import Get_Api_V1_Donations_Carbon_CalculateMCPTool - included in same package
// Import Get_Api_V1_Nonprofits_ShowMCPTool - included in same package
// Import Get_Api_V1_Donations_Crypto_CalculateMCPTool - included in same package
// Import Get_Api_V1_Donations_IndexMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Get_Api_V1_Donations_Carbon_StatsMCPTool.createGet_Api_V1_Donations_Carbon_StatsTool(config),
            Post_Api_V1_Donations_CreateMCPTool.createPost_Api_V1_Donations_CreateTool(config),
            Get_Api_V1_Donations_ShowMCPTool.createGet_Api_V1_Donations_ShowTool(config),
            Get_Api_V1_Nonprofits_ListMCPTool.createGet_Api_V1_Nonprofits_ListTool(config),
            Get_Api_V1_Donations_Carbon_CalculateMCPTool.createGet_Api_V1_Donations_Carbon_CalculateTool(config),
            Get_Api_V1_Nonprofits_ShowMCPTool.createGet_Api_V1_Nonprofits_ShowTool(config),
            Get_Api_V1_Donations_Crypto_CalculateMCPTool.createGet_Api_V1_Donations_Crypto_CalculateTool(config),
            Get_Api_V1_Donations_IndexMCPTool.createGet_Api_V1_Donations_IndexTool(config)
            );
